...
[NodeContent("MoveToWithKey", "Tasks/Custom/MoveToWithKey")]
public class MoveToWithKey : TaskNode
{
    [Title("Blackboard")]
    [SerializeField]
    ...
    protected override State OnUpdate()
    {
        ...
        {
            float tolerance = (float)Math.Round(acceptableRadius.GetValue()) + sensivity;
